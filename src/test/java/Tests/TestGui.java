...
public class TestGui extends ApplicationTest {
	...
	/*
		CREATECONFIGWIZARD_NODES[0] = "NAMEWIZARDPANE"
		CREATECONFIGWIZARD_NODES[1] = "NUMBERSWIZARDPANE"
		CREATECONFIGWIZARD_NODES[2] = "FILEWIZARDPANE"
	 */
	final String[] CREATECONFIGWIZARD_NODES = CreateConfigWizard.nodesId;
	...
	public void testB_SNT1() {
		click(SplashStageTestingNodes.NEW_BUTTON);
		TextField newTextField = lookfor(CreateConfigWizardTestingNodes.NamePane.getIdTextfield());
		click(newTextField.getId());
		writeText("foobar");
		Assertions.assertThat(newTextField).hasText("foobar");
	}
